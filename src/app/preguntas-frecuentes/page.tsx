    ...
    return (
        <div className="">
            <div className='bg-[#F8FAFB]'>
                <div className="pt-10 max-w-screen-md mx-auto flex items-center justify-start pb-10">
                    <div>
                        <Image src={question} alt="dreamimg" />
                    </div>
                    <div className='ml-28'>
            ...
            <div className="max-w-screen-lg mx-auto grid grid-cols-12 gap-3 mt-20 mb-16">
                <div className="grid-start-1 grid-end-2">
