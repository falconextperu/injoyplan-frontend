        ...
        <div className="">
            <div className='bg-[#F8FAFB]'>
                <div className="pt-10 max-w-screen-md mx-auto flex items-center justify-start">
                    ...
                    <div>
                        <h3 className={`${quicksand.className} ml-28 text-3xl font-bold text-[#9B292B]`}>Políticas de privacidad</h3>
                    </div>
                </div>
            </div>
            <div className={`${sans.className} max-w-screen-2xl md:w-[1200px] mt-20 mx-auto`}>
                <div>
                    <h5 className='text-[#333] font-bold mb-6'>1. Legislación aplicable</h5>
                    <p className='text-[#333]'>La presente política de privacidad se encuentra sujeta a la legislación peruana y en particular a la Ley N° 29733, Ley de Protección de Datos Personales y el Decreto Supremo N° 003-2013-JUS, Reglamento de la Ley N° 29733. <br />
                        <br /></p>
                </div>
                <div>
                    <h5 className='text-[#333] font-bold mb-6'>2. Información que tú proporcionas</h5>
                    <p className='text-[#333]'>La información que recibimos cuando te registras en nuestra Web y/o la Aplicación es la siguiente: <br />
                        <br />
                ...
                <div>
                    <h5 className='text-[#333] font-bold mb-6'>3. Tus mensajes</h5>
                    <p className='text-[#333]'>Sobre el contenido de los mensajes durante la prestación normal de nuestros Servicios, se conservará toda información que INJOYPLAN S.A.C., considere.  <br />
                        <br /> </p>
                </div>
                <div>
                    <h5 className='text-[#333] font-bold mb-6'>4. El resguardo de la información que proporciona</h5>
                    <p className='text-[#333]'>INJOYPLAN S.A.C. adopta las medidas técnicas y organizativas necesarias para garantizar la protección de la Información del Usuario y evitar su alteración, pérdida, tratamiento y/o acceso no autorizado, habida cuenta del estado de la técnica, la naturaleza de los datos almacenados y los riesgos a que están expuestos, todo ello, conforme a lo establecido por la Ley de Protección de Datos Personales, su Reglamento. <br />
                        <br />
                ...
                <div>
                    <h5 className='text-[#333] font-bold mb-6'>6. Sobre la veracidad de los Datos Personales</h5>
                    <p className='text-[#333]'>El Usuario declara que toda información proporcionada es verdadera, completa y exacta. Cada Usuario es responsable por la veracidad, exactitud, vigencia y autenticidad de la información suministrada, y se compromete a mantenerla debidamente actualizada. <br />
                        <br />
